...
/**
 * Original test cases based on pre-HS2019 format
 */
public class SignerWithAlgorithmTest extends Assert {
    ...
    public void testSign() throws Exception {
        ...
        { // method changed.  should get a different signature
            ...
            assertEquals("Signature keyId=\"hmac-key-1\",algorithm=\"hmac-sha256\",headers=\"content-length host date (request-target)\",signature=\"DPIsA/PWeYjySmfjw2P2SLJXZj1szDOei/Hh8nTcaPo=\"", signed.toString());
        }
        ...
        { // uri changed.  should get a different signature
            ...
            assertEquals("Signature keyId=\"hmac-key-1\",algorithm=\"hmac-sha256\",headers=\"content-length host date (request-target)\",signature=\"IWTDxmOoEJI67YxY3eDIRzxrsAtlYYCuGZxKlkUSYdA=\"", signed.toString());
        }
    }
